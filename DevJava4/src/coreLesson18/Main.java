...
import coreLesson14.Person;

public class Main {

	public static void main(String[] args) throws ReflectiveOperationException {
		Class<?> personClass = Class.forName("coreLesson14.Person");
		for (Field field : personClass.getDeclaredFields()) {
			System.out.println(field.getName());
		}

		// запхали персонв в базу
		...
		// вит€гнули з бази, але так правильн≥ше, н≥ж попередн≥й вар≥ант
